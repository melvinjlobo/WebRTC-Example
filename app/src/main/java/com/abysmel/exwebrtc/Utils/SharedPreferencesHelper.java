...
public final class SharedPreferencesHelper {
	...
	public static final String KEY_DB_TOKEN = "DropBoxToken";
	private static final String DEFAULT_SUFFIX = "_sharedpreferences";
	...
	private static void initPrefs(Context context, String prefsName, int mode) {
		mSharedPreference = context.getSharedPreferences(prefsName, mode);
	}
	 ...
	 */
	public static synchronized Set<String> getOrderedStringSet(String key, final Set<String> defValue) {
		SharedPreferences prefs = getPreferences();
	 ...
	 */
	@TargetApi(Build.VERSION_CODES.HONEYCOMB)
	public static synchronized void putStringSet(final String key, final Set<String> value) {
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
			final Editor editor = getPreferences().edit();
	 ...
	 * @see #getOrderedStringSet(String, Set)
	 */
	public static synchronized void putOrderedStringSet(String key, Set<String> value) {
		final Editor editor = getPreferences().edit();
		int stringSetLength = 0;
		if (mSharedPreference.contains(key + LENGTH)) {
			// First read what the value was
			stringSetLength = mSharedPreference.getInt(key + LENGTH, -1);
		}
	...
	public final static class Builder {
		 ...
		 * @return the {@link SharedPreferencesHelper.Builder} object.
		 */
		public Builder setSharedPreferenceName(final String prefsName) {
			mKey = prefsName;
			return this;
		}
		 ...
		 * @return the {@link com.bby.oms.util.SharedPreferencesHelper.Builder} object.
		 */
		...
		public void build() {
			...
			SharedPreferencesHelper.initPrefs(mContext, mKey, mMode);
		}
	}
}
